...
import { ClientParams as ClientParams$1, FeeConfiguration, WithIdempotencyKey, Pagination } from './core';
import * as _shared_clients_developer_controlled_wallets from './clients/developer-controlled-wallets';
import { ListWalletsBlockchainEnum, Blockchain, WalletMetadata, AccountType } from './clients/developer-controlled-wallets';
...
declare function initiateDeveloperControlledWalletsClient({ apiKey, baseUrl, entitySecret, storage, userAgent, }: ClientParams): {
     ...
     * ```
     */
    createTransaction: ({ idempotencyKey, fee, ...input }: CreateTransferTransactionInput) => Promise<_shared_core.TrimDataResponse<_shared_clients_developer_controlled_wallets.CreateDeveloperTransactionTransfer200Response>>;
    /**
     ...
     * ```
     */
    getTransaction: ({ id, txType }: _shared_core.GetTransactionInput) => Promise<_shared_core.TrimDataResponse<_shared_clients_developer_controlled_wallets.GetTransaction200Response>>;
    /**
     ...
     * ```
     */
    listTransactions: ({ blockchain, destinationAddress, includeAll, operation, state, txHash, txType, walletIds, from, pageAfter, pageBefore, pageSize, to, }: _shared_core.ListTransactionsInput) => Promise<_shared_core.TrimDataResponse<_shared_clients_developer_controlled_wallets.ListTransactions200Response>>;
    /**
     ...
     * ```
     */
    estimateContractExecutionFee: ({ source, abiParameters, ...input }: _shared_core.EstimateContractExecutionFeeInput) => Promise<_shared_core.TrimDataResponse<_shared_clients_developer_controlled_wallets.CreateTransferEstimateFee200Response>>;
    /**
     ...
     * ```
     */
    estimateTransferFee: ({ amount, ...input }: _shared_core.EstimateTransferFeeInput) => Promise<_shared_core.TrimDataResponse<_shared_clients_developer_controlled_wallets.CreateTransferEstimateFee200Response>>;
    /**
     ...
     * ```
     */
    validateAddress: (input: _shared_core.ValidateAddressInput) => Promise<_shared_core.TrimDataResponse<_shared_clients_developer_controlled_wallets.CreateValidateAddress200Response>>;
    /**
     ...
     * ```
     */
    getToken: ({ id }: _shared_core.GetTokenInput) => Promise<_shared_core.TrimDataResponse<_shared_clients_developer_controlled_wallets.GetTokenId200Response>>;
};
