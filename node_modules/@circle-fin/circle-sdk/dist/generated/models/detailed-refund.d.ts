...
export declare const DetailedRefundTypeEnum: {
    readonly Refund: "refund";
};
export declare type DetailedRefundTypeEnum = typeof DetailedRefundTypeEnum[keyof typeof DetailedRefundTypeEnum];
export declare const DetailedRefundDescriptionEnum: {
    readonly Payment: "Payment";
};
export declare type DetailedRefundDescriptionEnum = typeof DetailedRefundDescriptionEnum[keyof typeof DetailedRefundDescriptionEnum];
