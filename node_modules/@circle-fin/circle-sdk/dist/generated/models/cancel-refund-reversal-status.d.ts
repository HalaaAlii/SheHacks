 ...
 * @enum {string}
 */
export declare const CancelRefundReversalStatus: {
    readonly Pending: "pending";
    readonly Confirmed: "confirmed";
    readonly Paid: "paid";
    readonly Failed: "failed";
};
export declare type CancelRefundReversalStatus = typeof CancelRefundReversalStatus[keyof typeof CancelRefundReversalStatus];
