...
export declare const PaymentInfoCancelTypeEnum: {
    readonly Cancel: "cancel";
};
export declare type PaymentInfoCancelTypeEnum = typeof PaymentInfoCancelTypeEnum[keyof typeof PaymentInfoCancelTypeEnum];
export declare const PaymentInfoCancelDescriptionEnum: {
    readonly Payment: "Payment";
};
export declare type PaymentInfoCancelDescriptionEnum = typeof PaymentInfoCancelDescriptionEnum[keyof typeof PaymentInfoCancelDescriptionEnum];
