...
export declare const FiatPaymentPolymorphicTypeEnum: {
    readonly Payment: "payment";
    readonly Refund: "refund";
    readonly Cancel: "cancel";
};
export declare type FiatPaymentPolymorphicTypeEnum = typeof FiatPaymentPolymorphicTypeEnum[keyof typeof FiatPaymentPolymorphicTypeEnum];
export declare const FiatPaymentPolymorphicDescriptionEnum: {
    readonly Payment: "Payment";
};
export declare type FiatPaymentPolymorphicDescriptionEnum = typeof FiatPaymentPolymorphicDescriptionEnum[keyof typeof FiatPaymentPolymorphicDescriptionEnum];
