...
export declare const PaymentInfoPaymentAndRefundTypeEnum: {
    readonly Payment: "payment";
    readonly Refund: "refund";
};
export declare type PaymentInfoPaymentAndRefundTypeEnum = typeof PaymentInfoPaymentAndRefundTypeEnum[keyof typeof PaymentInfoPaymentAndRefundTypeEnum];
export declare const PaymentInfoPaymentAndRefundDescriptionEnum: {
    readonly Payment: "Payment";
};
export declare type PaymentInfoPaymentAndRefundDescriptionEnum = typeof PaymentInfoPaymentAndRefundDescriptionEnum[keyof typeof PaymentInfoPaymentAndRefundDescriptionEnum];
