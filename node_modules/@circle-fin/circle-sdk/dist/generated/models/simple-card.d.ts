...
export declare const SimpleCardNetworkEnum: {
    readonly Visa: "VISA";
    readonly Mastercard: "MASTERCARD";
    readonly Amex: "AMEX";
    readonly Unknown: "UNKNOWN";
};
export declare type SimpleCardNetworkEnum = typeof SimpleCardNetworkEnum[keyof typeof SimpleCardNetworkEnum];
export declare const SimpleCardFundingTypeEnum: {
    readonly Credit: "credit";
    readonly Debit: "debit";
    readonly Prepaid: "prepaid";
    readonly Unknown: "unknown";
};
export declare type SimpleCardFundingTypeEnum = typeof SimpleCardFundingTypeEnum[keyof typeof SimpleCardFundingTypeEnum];
