...
export declare const FiatCancelTypeEnum: {
    readonly Cancel: "cancel";
};
export declare type FiatCancelTypeEnum = typeof FiatCancelTypeEnum[keyof typeof FiatCancelTypeEnum];
export declare const FiatCancelDescriptionEnum: {
    readonly Payment: "Payment";
};
export declare type FiatCancelDescriptionEnum = typeof FiatCancelDescriptionEnum[keyof typeof FiatCancelDescriptionEnum];
